...
const Partnerhero = () => {
  return (
    <div className="flex bg-blue-700 py-5 justify-around gap-[3rem] flex-wrap ">
      {/* left section */}
      <div className=" md:h-[50vh] lg:h-[50vh] xl:h-[70vh] flex flex-col justify-center items-center md:items-start mt-4 px-[3rem]">
      ...
      {/* right section */}
      <div className="w-[20rem] mb-2 md:w-[23rem] lg:h-96 default:h-[70vh] xl:h-[70vh] mt-4 py-2 bg-white rounded">
        {/* top */}
